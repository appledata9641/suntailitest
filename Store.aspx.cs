...
namespace 網頁程式設計
{
    public partial class Store : System.Web.UI.Page
    {
        ...
        protected void turncateTableBT_Click(object sender, EventArgs e)
        {
            SqlConnection orderCon   =new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\clientData.mdf;Integrated Security=True");
            orderCon.Open();
            ...
            SqlCommand orderItemTruncateCmd = new SqlCommand("truncate table orderItemTable", orderCon);
            orderItemTruncateCmd.ExecuteNonQuery();
            orderBT.Text = "前往訂購";
        ...
        protected void drinkDataSelect_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
        {
